...
from .views import GetAuthURL, get_auth_callback, CheckUserAuth, LogoutSpotify, GetUserToken, GetSongOnPlay, \
...
urlpatterns = [
    ...
    path('get-playlist-items-all', GetPlaylistAllItems.as_view()),
